document.addEventListener("DOMContentLoaded", function(){
    ...
    svg.selectAll("rect")
        ...
        .attr("width", xScale(parseTime(dataset[1][0])) - xScale(parseTime(dataset[0][0])))
        .attr("height", (d) =>{
        ...
        .on("mouseover", function (d) {
            ...
            tooltip.transition()
                .duration(200)
                .style("opacity", 0.9);
            tooltip.text(`During ${d[0]} the GDP was $${d[1]} Billions`)  // Use html method instead of text
                .attr("data-date", d[0])  // Set data-date attribute in the tooltip
